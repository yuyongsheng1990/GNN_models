...
acm_filepath = os.path.abspath(os.path.join(os.getcwd(), "../..")) + '/data/han_data/ACM3025.mat'
...
adj_list, fea_list, y_train, y_val, y_test, train_mask, val_mask, test_mask = load_data_acm3025(path=acm_filepath)
if featype == 'adj':
    fea_list = adj_list
